...
public class DoublesSubstractionTest {
    @DataProvider
    public Object[][] dataProviderDoublesSubstraction() {
        return new Object[][]{
                {"34843,546", "-", "50,90"},
                {"68993,3478", "-", "505,383"},
                {"8372678,3423", "-", "283,23"},
    ...
    @Test(dataProvider = "dataProviderDoublesSubstraction")
    public void calculateDoublesSubstraction(
