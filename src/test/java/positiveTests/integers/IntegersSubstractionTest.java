...
public class IntegersSubstractionTest {
    @DataProvider
    public Object[][] dataProviderSubstraction() {
        return new Object[][]{
                {25, "-", 5},
                {33, "-", 17},
                {500, "-", 234},
    ...
    @Test(dataProvider = "dataProviderSubstraction")
    public void calculateIntegersSubstraction(int integer1, String sign, int integer2) {
        double number1;
        double number2;
        double doubleResult;
        double tempResult;
