...
public class IntegersNegativeSubstractionTest {
    @DataProvider
    public Object[][] dataProviderNegativeSubstraction() {
        return new Object[][]{
                {25, "-", "Test"},
                {-33, "-", "Test"},
                {15, "-", null}
    ...
    @Test(dataProvider = "dataProviderNegativeSubstraction")
    public void calculateNegativeSubstraction(int integer, String sign, String str) {
        double number1;
        double number2;
        ...
        while (true) {
            ...
            Scanner num2 = new Scanner(String.valueOf(str));
    ...
    @DataProvider
    public Object[][] dataProviderTwoStringsSubstraction() {
        return new Object[][]{
                {"Test", "-", "Test"},
        };
    }

    @Test(dataProvider = "dataProviderTwoStringsSubstraction")
    public void calculateTwoStringsSubstraction(String str1, String sign, String str2) {
        double number1;
        double number2;
        double doubleResult = 0.0;
        double tempResult;
