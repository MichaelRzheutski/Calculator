...
public class IntegersNegativeAdditionTest {

    @DataProvider
    public Object[][] dataProviderNegativeAddition() {
        return new Object[][]{
                {1, "+", "Test"},
                {-1, "+", "Test"},
                {20, "+", null}
    ...
    @Test(dataProvider = "dataProviderNegativeAddition")
    public void calculateNegativeAddition(int integer, String sign, String text) {
        double number1;
        double number2;
        double doubleResult;
        double tempResult;
    ...
    @DataProvider
    public Object[][] dataProviderTwoStringsAddition() {
        return new Object[][]{
                {"Test", "+", "Test"},
        };
    }
    @Test(dataProvider = "dataProviderTwoStringsAddition")
    public void calculateTwoStringsAddition(String str1, String sign, String str2) {
        double number1;
        double number2;
        double doubleResult;
        double tempResult;
