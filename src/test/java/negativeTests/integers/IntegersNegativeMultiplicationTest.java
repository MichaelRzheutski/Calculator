...
public class IntegersNegativeMultiplicationTest {

    @DataProvider
    public Object[][] dataProviderNegativeMultiplication() {
        return new Object[][]{
                {47, "*", "Test"},
                {-459, "*", "Test"},
                {2051, "*", null}
    ...
    @Test(dataProvider = "dataProviderNegativeMultiplication")
    public void calculateNegativeMultiplication(int integer, String sign, String text) {
        double number1;
        double number2;
        double doubleResult;
        double tempResult;
    ...
    @DataProvider
    public Object[][] dataProviderTwoStringsMultiplication() {
        return new Object[][]{
                {"Test", "*", "Test"},
        };
    }
    @Test(dataProvider = "dataProviderTwoStringsMultiplication")
    public void calculateTwoStringsMultiplication(String str1, String sign, String str2) {
        double number1;
        double number2;
        double doubleResult;
        double tempResult;
