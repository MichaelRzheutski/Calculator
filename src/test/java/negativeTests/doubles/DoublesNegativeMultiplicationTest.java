...
public class DoublesNegativeMultiplicationTest {
    @DataProvider
    public Object[][] dataProviderNegativeDecimalMultiplication() {
        return new Object[][]{
                {"300,546", "*", "Test"},
                {"6899,3478", "*", "Test"},
        };
    ...
    @Test(dataProvider = "dataProviderNegativeDecimalMultiplication")
    public void calculateNegativeDecimalMultiplication(
    ...
    @DataProvider
    public Object[][] dataProviderNullMultiplication() {
        return new Object[][]{
                {"6893,348", "*", null},
        };
    }
    ...
    @Test(
            dataProvider = "dataProviderNullMultiplication",
            expectedExceptions = {NullPointerException.class}
    )
    public void calculateNullMultiplication(
            String doubleString1, String sign, String doubleString2
    ) {
        double number1;
        double number2;
