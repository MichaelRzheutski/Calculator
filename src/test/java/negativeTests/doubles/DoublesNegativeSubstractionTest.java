...
public class DoublesNegativeSubstractionTest {
    @DataProvider
    public Object[][] dataProviderNegativeDecimalSubstraction() {
        return new Object[][]{
                {"34843,546", "-", "Test"},
                {"-68993,3478", "-", "Test"},
        };
    ...
    @Test(dataProvider = "dataProviderNegativeDecimalSubstraction")
    public void calculateNegativeDecimalSubstraction(
    ...
    @DataProvider
    public Object[][] dataProviderNullSubstraction() {
        return new Object[][]{
                {"68993,3478", "-", null},
        };
    }
    ...
    @Test(
            dataProvider = "dataProviderNullSubstraction",
            expectedExceptions = {NullPointerException.class}
    )
    public void calculateNullSubstraction(
            String doubleString1, String sign, String doubleString2
    ) {
        double number1;
        double number2;
