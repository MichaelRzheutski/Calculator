...
public class DoublesNegativeAdditionTest {

    @DataProvider
    public Object[][] dataProviderNegativeDecimalAddition() {
        return new Object[][]{
                {"234324,57", "+", "Test"},
                {"-1238,5", "+", "Test"},
        };
    ...
    @Test(dataProvider = "dataProviderNegativeDecimalAddition")
    public void calculateNegativeDecimalAddition(
    ...
    @DataProvider
    public Object[][] dataProviderNullAddition() {
        return new Object[][]{
                {"356,58", "+", null}
        };
    }
    ...
    @Test(
            dataProvider = "dataProviderNullAddition",
            expectedExceptions = {NullPointerException.class}
    )
    public void calculateNullAddition(
            String doubleString1, String sign, String doubleString2
    ) {
        double number1;
        double number2;
